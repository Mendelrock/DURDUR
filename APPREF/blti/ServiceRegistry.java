...
public class ServiceRegistry {
	...
	// une méthode de validation renvoie void et lève une exception esi non validation
	...
	private static void validation(Class<? extends Service> classe) throws ValidationException {
		...
		try {// Class.forName pour éviter import mais try-catch obligatoire... 
			try {c = classe.getConstructor(Class.forName("java.net.Socket"));} catch (ClassNotFoundException e) {} 
